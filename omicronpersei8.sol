...
contract omicronpersei8 is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "omicronpersei8";
    string private constant _symbol   = "NSFW";
    uint8  private constant _decimals = 9;
    
    uint256 public _taxFee       = 100; // 1% of every transaction is redistributed to holders
    uint256 public _liquidityFee = 200; // 2% of every transaction will be converted into BNB
